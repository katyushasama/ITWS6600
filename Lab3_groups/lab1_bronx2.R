library(readxl)
bronx1<-read_excel("~/Downloads/Co-term/ITWS6600/lab3_group2/rollingsales_bronx.xls",skip = 4)

#View(bronx1)
bronx1<-bronx1[which(bronx1$`SALE\nPRICE`!="0" & bronx1$`GROSS SQUARE FEET`!="0" & bronx1$`LAND SQUARE FEET`!="0"),]
...
addsample<-bronxadd[sample.int(n = dim(bronxadd)[1],size=nsample),]#I use nval here 
